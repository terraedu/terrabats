...
public class DepositPositions {
    ...
    public static double SAMPLE_TRANSFER = 0.35;
    ...
    public static double TRANSFER_PIVOT = 0.15;
    public static double TRANSFERGRAB_PIVOT = 0.3;
    ...
    public static double PARK_ARM = 0.95;
}